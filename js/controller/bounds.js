...
function checkLaserBounds() {
    points.forEach((point) => {
        ...
        for (const corner of playerCorners) {
            ...
            if (
                point.isInactive() &&
                rotatedX > -point.getWidth() / 2 &&
                rotatedX < point.getWidth() / 2 &&
                rotatedY > -point.getHeight() / 2 &&
                rotatedY < point.getHeight() / 2
            ) {
            ...
            if (point.isActive()) {
                ...
                if (
                    ...
                    angles.forEach((angle) => {
                        ...
                        const rotatedRayX =
                            angleCos * rotatedX - angleSin * rotatedY;
                        const rotatedRayY =
                            angleSin * rotatedX + angleCos * rotatedY;

                        if (
                            rotatedRayX > 0 &&
                            rotatedRayX < point.getSize() / 2 &&
                            Math.abs(rotatedRayY) < point.getHeight() / 2
                        ) {
                            player.die();
                        }
                    });
                ...
                if (
                    ...
                    if (
                        corner.y >= point.getY() - point.getWidth() / 2 &&
                        corner.y <= point.getY() + point.getWidth() / 2 &&
                        corner.x >= point.getX() - point.getSize() / 2 &&
                        corner.x <= point.getX() + point.getSize() / 2
                    ) {
                        player.die();
                    }
