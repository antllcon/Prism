...
function drawBonuses() {
    script_js_1.readyBonuses.forEach(function (bonus) {
        script_js_1.ctx.beginPath();
        script_js_1.ctx.arc(bonus.getX(), bonus.getY(), bonus.getSize(), 0, 2 * Math.PI);
        script_js_1.ctx.fillStyle = bonus.getColor();
        script_js_1.ctx.fill();
        script_js_1.ctx.closePath();
    });
}
